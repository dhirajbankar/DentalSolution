 ...
 * @author Sushant Raut
 */
public class initialSettings extends javax.swing.JFrame {
    
    SettingsDao settingsDao;
    DoctorDao doctorDao;
    UserDao userDao;
    final static Logger logger = Logger.getLogger(initialSettings.class);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new initialSettings().setVisible(true);
            }
        });
    }
    ...
    private void initComponents() {
        ...
        buttonPanelLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {cancelBtn, saveBtn});
