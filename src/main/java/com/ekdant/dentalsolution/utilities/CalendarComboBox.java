...
public class CalendarComboBox extends JComboBox {
  ...
  private class DatePanel extends javax.swing.JPanel {
    ...
    public DatePanel() {
      ...
      month = new String[]{"January", "February", "March", "April", "May", "June", "July", "August", "Sepetember",
  ...
  public void updateUI() {
    ...
    //s} else if (comboBoxUI instanceof WindowsComboBoxUI) {
  ...
  public void setEditable(boolean aFlag) {
    if (!aFlag) {
      throw new IllegalArgumentException("no sense in editable mode setting to false");
    }
  }
